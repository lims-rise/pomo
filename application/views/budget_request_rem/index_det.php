<div class="content-wrapper">
			...
			<form role="form"  id="formKeg" method="post" class="form-horizontal">
				<div class="box-body">
					...
					<div class="form-group">
						...
						<label for="budget_rem" class="col-sm-2 control-label">Budget Request</label>
						<div class="col-sm-4">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input class="form-control " id="budget_rem" name="budget_rem" value="<?php echo $budget_rem_rem ?>" disabled>
						</div>
					</div>
					...
					<label for="comments2" class="col-sm-2 control-label">Comments</label>
						<div class="col-sm-4">
							<input class="form-control " id="comments2" name="comments2" value="<?php echo $comments ?>" disabled>
						</div>
					</div>
				</div><!-- /.box-body -->
				</form>
	...
	<!--                                            <button type="submit" name="Save" value="simpan" class="btn btn-primary"><i class="fa fa-save"></i> Simpan</button> -->
							<!-- <button type="button" name="excel" id="excel" class="btn btn-success" onclick="location.href='<?php// echo site_url('budget_request_rem/excel_print'); ?>';"><i class="fa fa-file-excel-o"></i> Excel</button> -->
        ...
        <div class="modal fade" id="compose-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="formDetail" action=<?php echo site_url('budget_request_rem/savedetail') ?> method="post" class="form-horizontal">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        $('#compose-modal').on('shown.bs.modal', function () {
			// $.ajax({
			// 	type: "POST",
			// 	url: "<?php //echo site_url('budget_request_rem/getSumEstimatePrice/') ?>" + id_req,
			// 	success: function(data) {
			// 		var sumEstimatePrice = parseFloat(data);
			// 		var budgetReq = parseFloat($('#budget_req').val().replace(/,/g, ''));
			// 		var budgetRem = budgetReq - sumEstimatePrice;
			// 		$('#budget_rem').val(budgetRem.toLocaleString('en-US', { maximumFractionDigits: 2 }));
			// 		// $('#budget_rem').val(budgetRem);
			// 	}
			// });
		...
		table = $("#example2").DataTable({
			...
			info: false,
			bFilter: false,
			ajax: {"url": "../../budget_request_rem/subjson?id="+id_reqrem, "type": "POST"},
			columns: [
				// {"data": "id_reqrem"},
				{"data": "items"}, 
				{"data": "qty"},
		...
		$('#print').click(function() {
			location.href = '../../budget_request_rem/budreq_print/'+id_reqrem;
		});

		$('#excel').click(function() {
			location.href = '../../budget_request_rem/excel_print/'+id_reqrem;
		});
