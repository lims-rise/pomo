        ...
        <div class="box box-primary">
            ...
            <div class="noprint">
                <div class="modal-footer clearfix">
                    <button id='print' class="btn btn-primary no-print" onclick="document.title = '<?php echo 'Print_Budged_Request_'. date('Ymd')?>'; window.print();"><i class="fa fa-print"></i> Print</button>
