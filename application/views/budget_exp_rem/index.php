            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Purchase Order | Budget Remaining Expenses</h3>
                    </div>
...
<?php
        ...
        // }
?>        
		<?php echo anchor(site_url('budget_exp_rem/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to XLS', 'class="btn btn-success"'); ?></div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "budget_exp_rem/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
