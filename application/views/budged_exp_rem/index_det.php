	...
	<section class="content">
		<div class="box box-black box-solid">
			<div class="box-header with-border">
				<h3 class="box-title">Purchase Order | Budget Expenses Remaining Detail</h3>
			</div>
                    ...
                    <div class="col-xs-12"> 
                        <div class="box box-primary box-solid">
                            ...
                            <div class="box-header">
                                <h3 class="box-title">Detail Expenses Remaining</h3>
                            </div>
                ...
                <!--</div> row -->    
					<div class="form-group">
						<div class="modal-footer clearfix">
							<button type="button" name="excel" id="excel" class="btn btn-success" onclick="location.href='<?php echo site_url('Budged_exp_rem/excel_print'); ?>';"><i class="fa fa-file-excel-o"></i> Excel</button>
        ...
        <div class="modal fade" id="compose-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="formDetail" action=<?php echo site_url('Budged_exp_rem/savedetail') ?> method="post" class="form-horizontal">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		table = $("#example2").DataTable({
			...
			info: false,
			bFilter: false,
			ajax: {"url": "../../Budged_exp_rem/subjson?id="+id, "type": "POST"},
			columns: [
				{"data": "date_expenses"},
				{"data": "items"}, 
				{"data": "qty"},
		...
		// 	location.href = '../../Budged_exp_rem/budreq_print/'+id_req;
		// });


		$('#addtombol_det').click(function() {
			$('#mode_det').val('insert');
            $('#modal-title-detail').html('<i class="fa fa-wpforms"></i> New detail expenses remaining<span id="my-another-cool-loader"></span>');
		...
		$('#example2').on('click', '.btn_edit_det', function(){
			...
			console.log(data);
			$('#mode_det').val('edit');
			$('#modal-title-detail').html('<i class="fa fa-pencil-square"></i> Update detail expenses remaining<span id="my-another-cool-loader"></span>');
