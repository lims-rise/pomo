...
<?php
        ...
        // }
?>        
		<?php echo anchor(site_url('budget_expenses/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to XLS', 'class="btn btn-success"'); ?></div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "budget_expenses/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
