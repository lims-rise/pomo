...
class Budged_request extends CI_Controller
{
    ...
    {
        // $this->load->model('Budged_request_model');
        $data['person'] = $this->Budged_request_model->getLabtech();
        $data['objective'] = $this->Budged_request_model->getObjective();
        // $data['freezer'] = $this->Budged_request_model->getFreezer();
        // $data['shelf'] = $this->Budged_request_model->getShelf();
        // $data['rack'] = $this->Budged_request_model->getRack();
        // $data['rack_level'] = $this->Budged_request_model->getDrawer();
        $this->template->load('template','Budged_request/index', $data);
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->Budged_request_model->json();
    }

    public function subjson() {
        $id = $this->input->get('id',TRUE);
        header('Content-Type: application/json');
        echo $this->Budged_request_model->subjson($id);
    }
    ...
    public function getSumEstimatePrice($id_req) {
        ...
        $sumEstimatePrice = $this->Budged_request_model->getSumEstimatePrice($id_req);
    ...
    {
        // $this->template->load('template','Budged_request/index_det', $data);
        // $id_spec = $this->input->post('id_spec',TRUE);
        // $data['unit'] = $this->Budged_request_model->getUnits();
        $row = $this->Budged_request_model->get_detail($id);
        if ($row) {
            // $inv = $this->Budged_request_model->getInv();            
            $data = array(
                'id_req' => $row->id_req,
                ...
                'unit' => $this->Budged_request_model->getUnits(),
                );
                $this->template->load('template','Budged_request/index_det', $data);
        }
        else {
            // $this->template->load('template','Budged_request/index_det');
        }
    } 
    ...
    public function save() 
    {
        ...
        // $freezerloc = $this->Budged_request_model->getFreezLoc($f,$s,$r,$rl);
        $dt = new DateTime();
        ...
        if ($mode=="insert"){
            ...
            $this->Budged_request_model->insert($data);
            ...
            $this->Budged_request_model->update($id, $data);
            $this->session->set_flashdata('message', 'Create Record Success');    
        }

        redirect(site_url("Budged_request"));
    }
    ...
    public function savedetail() 
    {
        ...
        if ($mode=="insert"){
            ...
            $this->Budged_request_model->insert_det($data);
            $this->session->set_flashdata('message', 'Create Record Success');    
            ...
            $this->Budged_request_model->update_det($id_reqdetail, $data);
            $this->session->set_flashdata('message', 'Create Record Success');    
        }

        redirect(site_url("Budged_request/read/".$id_req));
    }

    public function budreq_print($id) 
    {
        $row = $this->Budged_request_model->get_rep($id);
        if ($row) {
            $data = array(
            'id_req' => $row->id_req,
            'date_req' => $row->date_req,
        ...
        // $data['items'] = $this->Tbl_receive_old_model->getItems();
            $this->template->load('template','Budged_request/index_rep', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url("Budged_request/read/".$id));
        }
    }
    ...
    public function spec_printdet() 
    {
        ...
        header('Content-Type: application/json');
        echo $this->Budged_request_model->get_repdet($id);
    }    

    public function delete($id) 
    {
        $row = $this->Budged_request_model->get_by_id($id);
        $data = array(
            'flag' => 1,
            );
    ...
    public function valid_bs()
    {
        ...
        $data = $this->Budged_request_model->validate1($id, $type);
        header('Content-Type: application/json');
    ...
    //     $rdeliver = $this->Budged_request_model->get_all();
    ...
    // $datenow=date("Ymd");
    // $fileName = 'Budged_request_'.$datenow.'.csv';
...
/* End of file Budged_request.php */
/* Location: ./application/controllers/Budged_request.php */
